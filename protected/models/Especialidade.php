 ...
 *
 * The followings are the available columns in table 'especialidade':
 * @property integer $id
 ...
 */
class Especialidade extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'militars' => array(self::HAS_MANY, 'Militar', 'id_especialidade'),
		);
	}
