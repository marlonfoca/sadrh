...
class Ferias extends CActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'concessivo_inicio' => 'Concessivo Inicio',
			'concessivo_fim' => 'Concessivo Fim',
			'ferias_inicio' => 'Ferias Inicio',
			'ferias_fim' => 'Ferias Fim',
			'n_dias' => 'N Dias',
			'tipo' => 'Tipo',
	...
	public function searchFerias($id_militar)
	{
		...
		$criteria->compare('tipo0',$this->tipo);

		$criteria->with=array('tipo0');
		$criteria->together;

		//$criteria->order='ferias_fim DESC';
