...
class EspecialidadeController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Especialidade');
	 ...
	 * @param Especialidade $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='especialidade-form')
		{
